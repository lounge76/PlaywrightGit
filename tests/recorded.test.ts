...
test('test', async ({ page }) => {
    ...
    await page.locator('[placeholder="E-Mail Address"]').fill('fredrikkihlman@gmail.com');

    // Press Tab
    await page.locator('[placeholder="E-Mail Address"]').press('Tab');

    // Fill [placeholder="Password"]
    await page.locator('[placeholder="Password"]').fill('fredrik123!');
    ...
    await page.locator('[placeholder="First Name"]').fill('Fredde');
